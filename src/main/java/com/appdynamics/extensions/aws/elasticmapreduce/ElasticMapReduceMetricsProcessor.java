...
public class ElasticMapReduceMetricsProcessor implements MetricsProcessor {
    ...
    public ElasticMapReduceMetricsProcessor(List<IncludeMetric> includeMetrics, List<Dimension> dimensions) {
    ...
    public List<Metric> createMetricStatsMapForUpload(NamespaceMetricStatistics namespaceMetricStats) {
        ...
        for (Dimension dimension : dimensions) {
            dimensionToMetricPathNameDictionary.put(dimension.getName(), "JobFlowId");
        }
